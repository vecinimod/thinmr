	...
	function NetworkStreamer(config)
	{
		...
		this.stream = function(url)
		{
			...
			function readChunk()
			{
				...
				if (config.step||config.chunk) //my dominic edit ||...
				{
			...
			function chunkLoaded()
			{
				...
				var finishedWithEntireFile = !(config.step||config.chunk) || start > getFileSize(xhr);
				...
				{
				    console.log('res atm',results.length);
